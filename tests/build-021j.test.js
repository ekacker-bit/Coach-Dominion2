...
assert.match(appHtml, /BUILD 021J \/\/ PERFORMANCE SIGNALS/);
...
assert.match(appHtml, /trends-intelligence\.js\?v=021j/);
assert.match(appHtml, /styles\.css\?v=021j/);
assert.match(appHtml, /app\.js\?v=021j/);
...
assert.match(moduleSource, /const VERSION = "021J\.1"/);
