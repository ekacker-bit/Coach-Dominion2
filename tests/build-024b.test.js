...
assert.match(html, /atlas-activation\.js\?v=024[bg]/);
assert.match(html, /styles\.css\?v=024[bcdefg]/);
assert.match(html, /app\.js\?v=024[bcdefg]/);
assert.match(activation, /const VERSION = "024[BG]\.1"/);
...
assert.match(worker, /coach-dominion-024[bcdefg]-v1/);
assert.match(worker, /atlas-activation\.js\?v=024[bg]/);
