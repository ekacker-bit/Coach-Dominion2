...
assert.match(html, /atlas-program\.js\?v=024[abcdefghijk]/);
assert.match(html, /styles\.css\?v=024[abcdefghijk]/);
assert.match(html, /app\.js\?v=024[abcdefghijk]/);
...
assert.match(worker, /coach-dominion-024[abcdefghijk]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[abcdefghijk]/);
