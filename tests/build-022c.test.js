...
test("022C has responsive visual hierarchy and a rotated app shell", () => {
  ...
  assert.match(worker, /coach-dominion-(?:022[c-g]|(?:023[abcdef]|(?:024[abcdefghijklmn]|025[abc])))-v1/);
  assert.match(worker, /progress-review\.js\?v=022c/);
  assert.match(worker, /app\.js\?v=(?:022[c-g]|(?:023[abcdef]|(?:024[abcdefghijklmn]|025[abc])))/);
});
