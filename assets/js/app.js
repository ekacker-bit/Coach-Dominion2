...
const STANDARDS_CATALOG = [
  ...
  { code: "CONDUCT-01", category: "Program Conduct", title: "Integrity and reporting", description: "Reporting must be honest and consistent.", evidenceRu…111379 tokens truncated…OR INSPECTION" ? "yellow" : "neutral"}`;
