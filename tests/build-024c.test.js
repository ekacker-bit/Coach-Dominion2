...
assert.match(html, /styles\.css\?v=(?:024[cdefgn]|025[abc])/);
assert.match(html, /app\.js\?v=(?:024[cdefghijklmn]|025[abc])/);
...
assert.match(worker, /coach-dominion-(?:024[cdefghijklmn]|025[abc])-v1/);
