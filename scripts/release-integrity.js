...
check("application version", html.includes('/assets/js/app.js?v=024f'), "app.html is not using the 024F application");
check("cache version", worker.includes('coach-dominion-024f-v1'), "service-worker cache was not rotated");
check("cached stylesheet", worker.includes('/assets/styles.css?v=024f'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=024f'), "service worker is caching the wrong application");
