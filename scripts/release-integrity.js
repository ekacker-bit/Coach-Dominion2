...
check("cache version", worker.includes('coach-dominion-028f-release-stabilization'), "service-worker cache namespace is stale");
...
check("recovery and Today order", app.includes("function stabilizeTodayCommandOrder") && app.includes('today.dataset.commandOrder = "028F"') && app.includes('priority: "RECOVER / PROTECT"') && app.includes('progression: "N/A — HELD"'), "Today or recovery-day semantics are incomplete");
