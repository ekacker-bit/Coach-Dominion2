...
- For Build 005A work, include the performance suite in validation: `node tests/performance-foundation.test.js` and `npm.cmd test` on Windows.
- For Build 005D work, include intelligence validation: `node tests/performance-intelligence.test.js`, `node tests/performance-ux.test.js`, and `npm.cmd test` on Windows.
