...
const STANDARDS_CATALOG = [
  ...
  { code: "NUTRITION-01", category: "Nutrition", title: "Nutrition target", description: "Nutrition targets should be followed unless a protected exception applies.", evidenceRule: "A missed nutrition target without a protected exception may warrant review.", defaultSeverity: "LEVEL I", repeatEscalates: true, manualRevi…204728 tokens truncated…{aggregate.weekStartDate} â€” ${aggregate.weekEndDate}`);
