...
assert.match(appHtml, /trends-intelligence\.js\?v=021l/);
assert.match(appHtml, /styles\.css\?v=021l/);
assert.match(appHtml, /app\.js\?v=021l/);
...
assert.match(moduleSource, /const VERSION = "021L\.1"/);
