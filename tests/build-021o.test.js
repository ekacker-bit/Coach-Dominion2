...
assert.match(html, /Set the week\. Move sessions\. Fix anything blocking the plan\./);
...
assert.match(html, /styles\.css\?v=(?:022[b-g]|023[abcdef])/);
assert.match(html, /app\.js\?v=(?:022[b-g]|023[abcdef])/);
assert.match(worker, /coach-dominion-(?:022[b-g]|023[abcdef])-v1/);
assert.match(worker, /styles\.css\?v=(?:022[b-g]|023[abcdef])/);
assert.match(worker, /app\.js\?v=(?:022[b-g]|023[abcdef])/);
