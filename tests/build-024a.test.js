...
assert.match(html, /atlas-program\.js\?v=024[abcdefghij]/);
assert.match(html, /styles\.css\?v=024[abcdefghij]/);
assert.match(html, /app\.js\?v=024[abcdefghij]/);
...
assert.match(worker, /coach-dominion-024[abcdefghij]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[abcdefghij]/);
