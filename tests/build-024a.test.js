...
assert.match(html, /atlas-program\.js\?v=(?:024[abcdefghijklmn]|025[abc])/);
assert.match(html, /styles\.css\?v=(?:024[abcdefghijklmn]|025[abc])/);
assert.match(html, /app\.js\?v=(?:024[abcdefghijklmn]|025[abc])/);
...
assert.match(worker, /coach-dominion-(?:024[abcdefghijklmn]|025[abc])-v1/);
assert.match(worker, /atlas-program\.js\?v=(?:024[abcdefghijklmn]|025[abc])/);
