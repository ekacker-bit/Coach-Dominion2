...
assert.match(html, /atlas-program\.js\?v=024[ab]/);
assert.match(html, /styles\.css\?v=024[ab]/);
assert.match(html, /app\.js\?v=024[ab]/);
...
assert.match(worker, /coach-dominion-024[ab]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[ab]/);
