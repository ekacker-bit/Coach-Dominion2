...
check("stylesheet version", html.includes('/assets/styles.css?v=023f'), "app.html is not using the 023F stylesheet");
check("application version", html.includes('/assets/js/app.js?v=023f'), "app.html is not using the 023F application");
check("cache version", worker.includes('coach-dominion-023f-v1'), "service-worker cache was not rotated");
check("cached stylesheet", worker.includes('/assets/styles.css?v=023f'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=023f'), "service worker is caching the wrong application");
