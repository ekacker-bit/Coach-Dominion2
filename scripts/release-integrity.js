...
check("Atlas activation engine", size("assets/js/atlas-activation.js") >= 9000 && read("assets/js/atlas-activation.js").includes('const VERSION = "024I.1"'), "024I activation engine appears incomplete");
...
check("application version", html.includes('/assets/js/app.js?v=024k'), "app.html is not using the 024K application");
check("cache version", worker.includes('coach-dominion-024k-v1'), "service-worker cache was not rotated");
check("cached stylesheet", worker.includes('/assets/styles.css?v=024f'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=024k'), "service worker is caching the wrong application");
