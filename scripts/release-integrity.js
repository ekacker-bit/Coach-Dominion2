...
check("stylesheet version", html.includes('/assets/styles.css?v=025c3-025i'), "app.html is not using the 025I stylesheet");
check("application version", html.includes('/assets/js/app.js?v=025c7-025h-025i'), "app.html is not using the 025I application");
check("strength logger version", html.includes('/assets/js/strength-training.js?v=025g-025i'), "app.html is not using the 025I Strength engine");
...
check("cache version", worker.includes('coach-dominion-025c-v1-025h-025i'), "service-worker cache namespace changed unexpectedly");
check("cached stylesheet", worker.includes('/assets/styles.css?v=025c3-025i'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=025c7-025h-025i'), "service worker is caching the wrong application");
...
check("cached Strength logger", worker.includes('/assets/js/strength-training.js?v=025g-025i'), "service worker is caching the wrong Strength engine");
...
check("training integrity", app.includes('previewingDraft: Boolean(savedDraft)') && app.includes('service-worker-reload:025i'), "025H training integrity repair is incomplete");
check("progression memory engine", strength.includes('const VERSION = "025I.1"') && strength.includes('function buildProgressionMemory') && strength.includes('function buildCompletionReport'), "025I progression memory engine is incomplete");
