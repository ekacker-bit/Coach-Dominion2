...
assert.match(html, /atlas-program\.js\?v=024[abcdefghijkl]/);
assert.match(html, /styles\.css\?v=024[abcdefghijkl]/);
assert.match(html, /app\.js\?v=024[abcdefghijkl]/);
...
assert.match(worker, /coach-dominion-024[abcdefghijkl]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[abcdefghijkl]/);
