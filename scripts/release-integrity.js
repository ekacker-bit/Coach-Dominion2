...
check("application version", html.includes('/assets/js/app.js?v=024m'), "app.html is not using the 024M application");
check("cache version", worker.includes('coach-dominion-024m-v1'), "service-worker cache was not rotated");
check("cached stylesheet", worker.includes('/assets/styles.css?v=024f'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=024m'), "service worker is caching the wrong application");
