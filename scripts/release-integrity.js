...
check("Atlas activation engine", size("assets/js/atlas-activation.js") >= 9000 && read("assets/js/atlas-activation.js").includes('const VERSION = "024G.1"'), "024G activation engine appears incomplete");
check("Atlas activation integration", html.includes('/assets/js/atlas-activation.js?v=024g') && app.includes("buildAtlasProgramPreflight") && app.includes("snapshotAtlasActivationState") && app.includes("calendarLinkedToCandidates"), "024G atomic activation flow is missing");
...
check("application version", html.includes('/assets/js/app.js?v=024g'), "app.html is not using the 024G application");
check("cache version", worker.includes('coach-dominion-024g-v1'), "service-worker cache was not rotated");
check("cached stylesheet", worker.includes('/assets/styles.css?v=024f'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=024g'), "service worker is caching the wrong application");
...
check("cached Atlas activation", worker.includes('/assets/js/atlas-activation.js?v=024g'), "service worker is not caching the Atlas activation engine");
