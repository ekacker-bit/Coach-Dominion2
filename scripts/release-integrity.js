...
check("stylesheet", size("assets/styles.css") >= 250000, `styles.css is only ${size("assets/styles.css")} bytes`);
...
check("stylesheet version", html.includes('/assets/styles.css?v=021o'), "app.html is not using the 021O stylesheet");
check("application version", html.includes('/assets/js/app.js?v=021o'), "app.html is not using the 021O application");
check("cache version", worker.includes('coach-dominion-021o-v1'), "service-worker cache was not rotated");
check("cached stylesheet", worker.includes('/assets/styles.css?v=021o'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=021o'), "service worker is caching the wrong application");
