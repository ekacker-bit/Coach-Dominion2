...
assert.match(html, /atlas-program\.js\?v=024[abcde]/);
assert.match(html, /styles\.css\?v=024[abcde]/);
assert.match(html, /app\.js\?v=024[abcde]/);
...
assert.match(worker, /coach-dominion-024[abcde]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[abcde]/);
