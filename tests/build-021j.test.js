...
assert.match(appHtml, /trends-intelligence\.js\?v=021k/);
assert.match(appHtml, /styles\.css\?v=021k/);
assert.match(appHtml, /app\.js\?v=021k/);
...
assert.match(moduleSource, /const VERSION = "021K\.1"/);
