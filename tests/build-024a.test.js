...
assert.match(html, /atlas-program\.js\?v=024a/);
assert.match(html, /styles\.css\?v=024a/);
assert.match(html, /app\.js\?v=024a/);
...
assert.match(worker, /coach-dominion-024a-v1/);
assert.match(worker, /atlas-program\.js\?v=024a/);
