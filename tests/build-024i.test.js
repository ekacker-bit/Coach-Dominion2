...
assert.match(html, /app\.js\?v=024[ij]/);
assert.match(worker, /coach-dominion-024[ij]-v1/);
assert.match(activation, /const VERSION = "024I\.1"/);
...
assert.match(app, /commitUnifiedWeekDraft\(\{ activationPreflight: preflight \}\)/);
