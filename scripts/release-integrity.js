...
check("Atlas activation engine", size("assets/js/atlas-activation.js") >= 9000 && read("assets/js/atlas-activation.js").includes('const VERSION = "024I.2"'), "024I activation engine appears incomplete");
check("Atlas activation integration", html.includes('/assets/js/atlas-activation.js?v=024i') && app.includes("buildAtlasProgramPreflight") && app.includes("snapshotAtlasActivationState") && app.includes("canCommitCalendarFromPreflight"), "024I verified calendar handoff is missing");
...
check("application version", html.includes('/assets/js/app.js?v=024l'), "app.html is not using the 024L application");
check("cache version", worker.includes('coach-dominion-024l-v1'), "service-worker cache was not rotated");
check("cached stylesheet", worker.includes('/assets/styles.css?v=024f'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=024l'), "service worker is caching the wrong application");
...
check("cached Atlas activation", worker.includes('/assets/js/atlas-activation.js?v=024i'), "service worker is not caching the Atlas activation engine");
