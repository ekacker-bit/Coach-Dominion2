...
assert.match(html, /styles\.css\?v=(?:024[cdefgn]|025a)/);
assert.match(html, /app\.js\?v=(?:024[cdefghijklmn]|025a)/);
...
assert.match(worker, /coach-dominion-(?:024[cdefghijklmn]|025a)-v1/);
