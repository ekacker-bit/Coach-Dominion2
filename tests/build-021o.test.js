...
assert.match(html, /styles\.css\?v=022[b-e]/);
assert.match(html, /app\.js\?v=022[b-e]/);
assert.match(worker, /coach-dominion-022[b-e]-v1/);
assert.match(worker, /styles\.css\?v=022[b-e]/);
assert.match(worker, /app\.js\?v=022[b-e]/);
