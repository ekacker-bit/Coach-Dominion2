...
assert.match(worker, /coach-dominion-(?:022[b-g]|(?:023[abcdef]|024[ab]))-v1/);
assert.match(worker, /styles\.css\?v=(?:022[b-g]|(?:023[abcdef]|024[ab]))/);
assert.match(worker, /app\.js\?v=(?:022[b-g]|(?:023[abcdef]|024[ab]))/);
