...
assert.match(html, /atlas-program\.js\?v=024[abcdefg]/);
assert.match(html, /styles\.css\?v=024[abcdefg]/);
assert.match(html, /app\.js\?v=024[abcdefg]/);
...
assert.match(worker, /coach-dominion-024[abcdefg]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[abcdefg]/);
