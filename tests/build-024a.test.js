...
assert.match(html, /atlas-program\.js\?v=024[abcd]/);
assert.match(html, /styles\.css\?v=024[abcd]/);
assert.match(html, /app\.js\?v=024[abcd]/);
...
assert.match(worker, /coach-dominion-024[abcd]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[abcd]/);
