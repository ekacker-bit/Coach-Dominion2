...
assert.match(html, /atlas-program\.js\?v=024[abcdefghijklm]/);
assert.match(html, /styles\.css\?v=024[abcdefghijklm]/);
assert.match(html, /app\.js\?v=024[abcdefghijklm]/);
...
assert.match(worker, /coach-dominion-024[abcdefghijklm]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[abcdefghijklm]/);
