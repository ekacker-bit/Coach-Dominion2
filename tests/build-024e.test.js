...
assert.match(html, /atlas-program-repair\.js\?v=024e/);
assert.ok(html.indexOf("atlas-program-repair.js") < html.indexOf("app.js"), "repair engine must load before app integration");
assert.match(html, /styles\.css\?v=024e/);
assert.match(html, /app\.js\?v=024e/);
assert.match(engine, /const VERSION = "024E\.1"/);
...
assert.match(worker, /coach-dominion-024e-v1/);
assert.match(worker, /atlas-program-repair\.js\?v=024e/);
assert.match(packageJson, /test:024e/);

console.log("Build 024E integration tests passed.");
