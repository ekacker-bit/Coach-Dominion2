...
assert.match(worker, /coach-dominion-(?:022[b-g]|(?:023[abcdef]|024a))-v1/);
assert.match(worker, /styles\.css\?v=(?:022[b-g]|(?:023[abcdef]|024a))/);
assert.match(worker, /app\.js\?v=(?:022[b-g]|(?:023[abcdef]|024a))/);
