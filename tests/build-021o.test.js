...
assert.match(html, /styles\.css\?v=(?:022[b-g]|(?:023[abcdef]|024[abcde]))/);
assert.match(html, /app\.js\?v=(?:022[b-g]|(?:023[abcdef]|024[abcde]))/);
assert.match(worker, /coach-dominion-(?:022[b-g]|(?:023[abcdef]|024[abcde]))-v1/);
assert.match(worker, /styles\.css\?v=(?:022[b-g]|(?:023[abcdef]|024[abcde]))/);
assert.match(worker, /app\.js\?v=(?:022[b-g]|(?:023[abcdef]|024[abcde]))/);
