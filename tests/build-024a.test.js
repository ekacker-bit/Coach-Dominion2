...
assert.match(html, /atlas-program\.js\?v=024[abcdefghi]/);
assert.match(html, /styles\.css\?v=024[abcdefghi]/);
assert.match(html, /app\.js\?v=024[abcdefghi]/);
...
assert.match(worker, /coach-dominion-024[abcdefghi]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[abcdefghi]/);
