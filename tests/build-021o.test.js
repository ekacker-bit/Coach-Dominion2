...
assert.match(html, /styles\.css\?v=(?:022[b-g]|(?:023[abcdef]|024[abcdefghijk]))/);
assert.match(html, /app\.js\?v=(?:022[b-g]|(?:023[abcdef]|024[abcdefghijk]))/);
assert.match(worker, /coach-dominion-(?:022[b-g]|(?:023[abcdef]|024[abcdefghijk]))-v1/);
assert.match(worker, /styles\.css\?v=(?:022[b-g]|(?:023[abcdef]|024[abcdefghijk]))/);
assert.match(worker, /app\.js\?v=(?:022[b-g]|(?:023[abcdef]|024[abcdefghijk]))/);
