...
check("Atlas program integration", html.includes('/assets/js/atlas-program.js?v=024e') && app.includes("approveAtlasProgram") && app.includes("APPROVE_PROGRAM"), "024E one-approval program flow is missing");
...
check("Atlas repair engine", size("assets/js/atlas-program-repair.js") >= 5000 && read("assets/js/atlas-program-repair.js").includes('const VERSION = "024E.1"'), "024E repair engine appears incomplete");
check("Atlas repair integration", html.includes('/assets/js/atlas-program-repair.js?v=024e') && html.includes('id="atlas-program-repair-dialog"') && app.includes("openAtlasProgramRepairPreview") && app.includes("repairOnly"), "024E guided repair flow is missing");
check("stylesheet version", html.includes('/assets/styles.css?v=024e'), "app.html is not using the 024E stylesheet");
check("application version", html.includes('/assets/js/app.js?v=024e'), "app.html is not using the 024E application");
check("cache version", worker.includes('coach-dominion-024e-v1'), "service-worker cache was not rotated");
check("cached stylesheet", worker.includes('/assets/styles.css?v=024e'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=024e'), "service worker is caching the wrong application");
...
check("cached Atlas program", worker.includes('/assets/js/atlas-program.js?v=024e'), "service worker is not caching the Atlas program engine");
check("cached Atlas repair", worker.includes('/assets/js/atlas-program-repair.js?v=024e'), "service worker is not caching the Atlas repair engine");
