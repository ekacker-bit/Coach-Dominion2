...
assert.match(html, /atlas-activation\.js\?v=024[bgh]/);
assert.match(html, /styles\.css\?v=024[bcdefg]/);
assert.match(html, /app\.js\?v=024[bcdefgh]/);
assert.match(activation, /const VERSION = "024[BGH]\.1"/);
...
assert.match(worker, /coach-dominion-024[bcdefgh]-v1/);
assert.match(worker, /atlas-activation\.js\?v=024[bgh]/);
