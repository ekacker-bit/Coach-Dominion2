...
check("stylesheet version", html.includes('/assets/styles.css?v=024a'), "app.html is not using the 024A stylesheet");
check("application version", html.includes('/assets/js/app.js?v=024a'), "app.html is not using the 024A application");
check("cache version", worker.includes('coach-dominion-024a-v1'), "service-worker cache was not rotated");
check("cached stylesheet", worker.includes('/assets/styles.css?v=024a'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=024a'), "service worker is caching the wrong application");
