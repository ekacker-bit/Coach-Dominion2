...
assert.match(html, /styles\.css\?v=(?:024[bcdefgn]|025[abc])/);
assert.match(html, /app\.js\?v=(?:024[bcdefghijklmn]|025[abc])/);
...
assert.match(worker, /coach-dominion-(?:024[bcdefghijklmn]|025[abc])-v1/);
