...
test("Build 022A is responsive, cached, and versioned", () => {
  ...
  assert.match(html, /styles\.css\?v=(?:022[b-g]|(?:023[abcdef]|(?:024[abcdefghijklmn]|025a)|025a))/);
  assert.match(html, /app\.js\?v=(?:022[b-g]|(?:023[abcdef]|(?:024[abcdefghijklmn]|025a)|025a))/);
  assert.match(worker, /coach-dominion-(?:022[b-g]|(?:023[abcdef]|(?:024[abcdefghijklmn]|025a)|025a))-v1/);
