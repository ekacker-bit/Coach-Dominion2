...
check("application version", html.includes('/assets/js/app.js?v=025c7-025h'), "app.html is not using the 025H application");
...
check("cache version", worker.includes('coach-dominion-025c-v1-025h'), "service-worker cache namespace changed unexpectedly");
check("cached stylesheet", worker.includes('/assets/styles.css?v=025c3'), "service worker is caching the wrong stylesheet");
check("cached application", worker.includes('/assets/js/app.js?v=025c7-025h'), "service worker is caching the wrong application");
...
check("training integrity", app.includes('previewingDraft: Boolean(savedDraft)') && app.includes('service-worker-reload:025h'), "025H training integrity repair is incomplete");
