...
assert.match(html, /atlas-program\.js\?v=024[abcdefgh]/);
assert.match(html, /styles\.css\?v=024[abcdefgh]/);
assert.match(html, /app\.js\?v=024[abcdefgh]/);
...
assert.match(worker, /coach-dominion-024[abcdefgh]-v1/);
assert.match(worker, /atlas-program\.js\?v=024[abcdefgh]/);
